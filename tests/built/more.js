...
var lightgl_js_1 = require("./lightgl.js");
...
function rotate(c, a, v) {
    var m = lightgl_js_1.default.Matrix.rotate(a, v.x, v.y, v.z);
    var p = [];
    c.polygons.forEach(function (e) {
...
var Line = /** @class */ (function () {
    ...
    Line.prototype.arc = function (_a) {
        var rx = _a.rx, _b = _a.ry, ry = _b === void 0 ? rx : _b, _c = _a.start, start = _c === void 0 ? 0 : _c, _d = _a.arc, arc = _d === void 0 ? Math.PI / 2 : _d, _e = _a.slices, slices = _e === void 0 ? 4 : _e;
        var end = start + arc;
